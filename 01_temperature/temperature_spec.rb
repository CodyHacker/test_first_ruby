...
describe "temperature conversion functions" do
  ...
  describe "#ftoc" do
    ...
    it "converts freezing temperature" do
     # ftoc(32).should == 0
      expect(ftoc(32)).to be == 0
    end

    it "converts boiling temperature" do
   #   ftoc(212).should == 100
      expect(ftoc(212)).to be == 100
end

    it "converts body temperature" do
   #   ftoc(98.6).should == 37
      expect(ftoc(98.6)).to be == 37
    end

    it "converts arbitrary temperature" do
 #     ftoc(68).should == 20
      expect(ftoc(68)).to be == 20
    end
  ...
  describe "#ctof" do
    ...
    it "converts freezing temperature" do
 #     ctof(0).should == 32       
      expect(ctof(0)).to be == 32
   end

    it "converts boiling temperature" do
  #    ctof(100).should == 212
      expect(ctof(100)).to be == 212
    end

    it "converts arbitrary temperature" do
  #    ctof(20).should == 68
      expect(ctof(20)).to be == 68
   end
